...
export default function NewTask({onAdd, languages}) {
    ...
    return (
        <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex flex-col items-center gap-1"><label className="text-xl text-black font-bold" htmlFor="taskDate">{languages.taskDate}</label>
            ...
            <div className="flex flex-col items-center gap-1 "><label className="text-xl text-black font-bold" htmlFor="taskTime">{languages.taskDeadLine}</label>
            ...
            <button onClick={handleClick} className="w-32 shadow-xl rounded-lg px-4 text-center text-white py-2 bg-stone-800 opacity-85  text-xl  hover:opacity-100  transition-opacity">{languages.taskBtn}</button>
        </div>
    );
}
